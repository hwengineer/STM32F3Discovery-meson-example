...
.equ  BootRAM,        0xF1E0F85F /*define value to variable BootRAM*/
...
/*  b	LoopCopyDataInit */ /* copy initialized data to ram      */
/*CopyDataInit:
/*  ldr	r3, =_sidata   */ /* load data in flash adress into r3 */
/*  ldr	r3, [r3, r1]   */ /* load r3 = r3 + r1                 */
/*  str	r3, [r0, r1]   */ /* store @r3 = @[r0 +r1]             */
/*  adds	r1, r1, #4   */ /* increment r1 by 4                 */
/*LoopCopyDataInit:
/*  ldr	r0, =_sdata    */ /* load start adress into r0 */
/*  ldr	r3, =_edata    */ /* load end adress to r0     */
/*  adds	r2, r0, r1   */ /* add r2 = r0 + r1          */
/*  cmp	r2, r3         */ /* compare r2,r3             */
/*  bcc	CopyDataInit   */ /* branch if r2 < r3         */

/*  ldr	r2, =_sbss     */ /* load start adress of bss section */
/*	b	LoopFillZerobss  */ /* Zero fill the bss segment. */
/*FillZerobss:
/*	movs	r3, #0       *//* move r3 = 0         */
/*	str	r3, [r2], #4   *//* store @r3 = @r2 and auto increment r2 by 4 */
/*LoopFillZerobss:
/*	ldr	r3, = _ebss    *//* load end adress of bss section */
/*	cmp	r2, r3         *//* compare r2,r3             */
/*	bcc	FillZerobss    *//* branch if r2 < r3         */
...
/*
  ARM Assembly :
    - Move  = Regsiter to Register
    - Load  = Memory to Register
    - Store = Register to Memory

http://cseweb.ucsd.edu/~airturk/CSE30/topic08.pdf
*/
